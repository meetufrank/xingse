...
E_D("replace into `wxch_cfg` values('2','baseurl','http://demo.tgroupon.cn/','yes');");
E_D("replace into `wxch_cfg` values('3','imgpath','local','yes');");
E_D("replace into `wxch_cfg` values('4','plustj','true','yes');");
E_D("replace into `wxch_cfg` values('5','userpwd','tgroupon','yes');");
...
E_D("replace into `wxch_cfg` values('11','q_name','tgroupon','yes');");
E_D("replace into `wxch_cfg` values('12','tianxin_url','http://www.tgroupon.cn','yes');");
