...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','tgroupon分销系统','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','tgroupon分销系统','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','tgroupon分销系统','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','tgroupon分销系统','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','tgroupon分销系统','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','81356625','1');");
