...
<div class="address">
	...
	<p>省份：<input type="text" id="proviceFirstStageName" /></p>
	<p>城市：<input type="text" id="addressCitySecondStageName" /></p>
	<p>区：<input type="text" id="addressCountiesThirdStageName" /></p>
	<p>详细地址：<input type="text" id="addressDetailInfo" /></p>
	<p>电话：<input type="text" id="telNumber" /></p>
</div>
...
$('#address').click(function(){
    WeixinJSBridge.invoke('editAddress', {
        ...
        if(res.err_msg=='edit_address:ok')
        {
			...
			$("#proviceFirstStageName").val(data.proviceFirstStageName);
			$("#addressCitySecondStageName").val(data.addressCitySecondStageName);
			$("#addressCountiesThirdStageName").val(data.addressCountiesThirdStageName);
			$("#addressDetailInfo").val(data.addressDetailInfo);
