...
/**
 * The TGROUPON Control panel member the data integration plug-in management program language file
 * ============================================================================
 * All right reserved (C) 2005-2011 Beijing Yi Shang Interactive Technology
 * Development Ltd.
 * Web site: http://www.tgroupon.cn
 * ----------------------------------------------------------------------------
...
$_LANG['need_not_setup'] = 'You needn\`t set wehn you use TGROUPON systerm';
$_LANG['neednot_sync'] ='You needn\'t synchronous operation, beacuse the TGROUPON member system is in use now.';
$_LANG['different_domain'] ='The integration object and TGROUPON of[with] your setup is not under same area.<Br/>you member\'s data that can share that system, but can\'t carry out to register in the meantime.';
