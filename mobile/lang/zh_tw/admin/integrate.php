...
/**
 * TGROUPON 管理中心會員數據整合插件管理程序語言文件
 * ============================================================================
 * 版權所有 2005-2011 上海商派網絡科技有限公司，並保留所有權利。
 * 網站地址: http://www.tgroupon.cn；
 * ----------------------------------------------------------------------------
...
$_LANG['need_not_setup'] = '當您採用TGROUPON會員系統時，無須進行設置。';
$_LANG['different_domain'] = '您設置的整合對像和 TGROUPON 不在同一域下。<br />您將只能共享該系統的會員數據，但無法實現同時登錄。';
