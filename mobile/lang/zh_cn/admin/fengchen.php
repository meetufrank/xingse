...
$_LANG['article_name_exist'] = '有相同的分成名称存在!';
...
$_LANG['isopen'] ='显示';
$_LANG['isclose'] ='不显示';
$_LANG['no_article'] = '您现在还没有任何分成';
$_LANG['no_select_article'] = '您没有选择任何分成';
$_LANG['no_select_act'] = '请选择分成分类！';

$_LANG['display'] = '显示分成内容';
$_LANG['download'] = '下载文件';
$_LANG['both'] = '既显示分成内容又下载文件';
...
$_LANG['article_edit'] = '编辑分成内容';
$_LANG['tab_general'] = '通用信息';
$_LANG['tab_content'] = '分成内容';
$_LANG['tab_goods'] = '关联商品';

$_LANG['link_goods'] = '跟该分成关联的商品';
$_LANG['keyword'] = '关键字';
