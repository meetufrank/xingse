...
$_LANG['go_allot_priv'] = '设置设计师权限';

$_LANG['view_log'] = '查看日志';

$_LANG['back_home'] = '返回首页';
$_LANG['forget_pwd'] = '您忘记了密码吗?';
$_LANG['get_new_pwd'] = '找回设计师密码';
...
$_LANG['move_up'] = '上移';
$_LANG['move_down'] = '下移';
$_LANG['continue_add'] = '继续添加设计师';
$_LANG['back_list'] = '返回设计师列表';
$_LANG['select_role'] = '角色选择';
$_LANG['select_please'] = '请选择...';

$_LANG['admin_edit'] = '编辑设计师';
$_LANG['edit_pwd'] = '修改密码';

$_LANG['back_admin_list'] = '返回设计师列表';

/* 提示信息 */
$_LANG['js_languages']['user_name_empty'] = '设计师用户名不能为空!';
...
$_LANG['user_name_exist'] = '该设计师已经存在!';
...
$_LANG['edit_admininfo_cannot'] = '您不能对此设计师的权限进行任何操作!';
$_LANG['edit_remove_cannot'] = '您不能删除demo这个设计师!';
$_LANG['remove_self_cannot'] = '您不能删除自己!';
$_LANG['remove_cannot'] = '此设计师您不能进行删除操作!';
...
$_LANG['email_notic'] = '输入设计师的Email邮箱,必须为Email格式';
$_LANG['confirm_notic'] = '输入设计师的确认密码,两次输入必须一致';

/* 登录表单 */
$_LANG['label_username'] = '设计师姓名：';
$_LANG['label_password'] = '设计师密码：';
