...
$_LANG['need_not_setup'] = '当您采用TGROUPON会员系统时，无须进行设置。';
$_LANG['different_domain'] = '您设置的整合对象和 TGROUPON 不在同一域下。<br />您将只能共享该系统的会员数据，但无法实现同时登录。';
