...
<table cellpadding="3" cellspacing="1">
  <tr>
	...
	<th><font color="red">是否是分销商</font></th>
...
?>
  <tr>
	...
	<td align="center"><img src="images/<?php if ($this->_var['user']['is_fenxiao']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_hot', <?php echo $this->_var['user']['user_id']; ?>)" /></td>
